...
public class highBarClimb extends SequentialCommandGroup {
  ...
  /** Add your docs here. */
  public highBarClimb() {
    addCommands(new moveGrippyArm(-.8, 8), 
    new WaitCommand(.25),
    new moveGrippyArm(0.25, 45), 
    new WaitCommand(.25), 
    new moveGrippyArm(0.8, 60),  
    new WaitCommand(.5), 
    new ToggleGrippySoliniod(),  
    new WaitCommand(3), 
    new moveGrippyArm(0.8, 180),  
    new WaitCommand(1),  
    new ToggleGrippySoliniod(),  
    new WaitCommand(1), 
    new moveGrippyArm(-0.8, 30), 
    new WaitCommand(.25), 
    new moveGrippyArm(0.25, 70), 
    new WaitCommand(.25),  
    new moveGrippyArm(-0.8, 15), 
    new WaitCommand(.25), 
    new moveGrippyArm(0.25, 40));  
