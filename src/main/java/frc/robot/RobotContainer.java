...
import frc.robot.commands.CurrentZeroSequence;
...
import frc.robot.commands.ZeroWithCurrent;
import frc.robot.commands.highBarClimb;
import frc.robot.commands.moveGrippyArm;
...
public class RobotContainer {
    ...
    public void configureButtonBindings() {
        ...
        _con.right_stick_button.whenPressed(new CurrentZeroSequence());
